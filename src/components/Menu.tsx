...
const Menu = () => {
  ...
  return (
    <div>
        ...
        {open && (<div className="bg-red-400 text-white absolute left-0 top-20 w-full h-[calc(100vh-6rem)] flex flex-col gap-8 items-center justify-center text-3xl z-10">
            {links.map(item=>(
            ...
            <Link href="/carts" onClick={()=>setOpen(false)}>
                <Carticon/>
            </Link>
        </div>)}
